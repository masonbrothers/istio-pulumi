...
export class RequestAuthentication extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.security.v1.RequestAuthenticationSpec>;
...
export interface RequestAuthenticationArgs {
    ...
    spec?: pulumi.Input<inputs.security.v1.RequestAuthenticationSpec | undefined>;
}
