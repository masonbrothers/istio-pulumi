...
export class PeerAuthentication extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.security.v1.PeerAuthenticationSpec>;
...
export interface PeerAuthenticationArgs {
    ...
    spec?: pulumi.Input<inputs.security.v1.PeerAuthenticationSpec | undefined>;
}
