...
export class PeerAuthentication extends pulumi.CustomResource {
     ...
     */
    public readonly spec!: pulumi.Output<outputs.security.v1.PeerAuthenticationSpec | undefined>;
...
export interface PeerAuthenticationArgs {
     ...
     * Peer authentication configuration for workloads. See more details at: https://istio.io/docs/reference/config/security/peer_authentication.html
     */
    spec?: pulumi.Input<inputs.security.v1.PeerAuthenticationSpecArgs>;
