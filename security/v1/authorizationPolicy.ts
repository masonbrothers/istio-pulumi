...
export class AuthorizationPolicy extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.security.v1.AuthorizationPolicySpec>;
...
export interface AuthorizationPolicyArgs {
    ...
    spec?: pulumi.Input<inputs.security.v1.AuthorizationPolicySpec | undefined>;
}
