...
export class RequestAuthentication extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.security.v1beta1.RequestAuthenticationSpec>;
...
export interface RequestAuthenticationArgs {
    ...
    spec?: pulumi.Input<inputs.security.v1beta1.RequestAuthenticationSpec | undefined>;
}
