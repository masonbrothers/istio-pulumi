...
export class Telemetry extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.telemetry.v1alpha1.TelemetrySpec>;
...
export interface TelemetryArgs {
    ...
    spec?: pulumi.Input<inputs.telemetry.v1alpha1.TelemetrySpec | undefined>;
}
