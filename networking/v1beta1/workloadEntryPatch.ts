...
export class WorkloadEntryPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1beta1.WorkloadEntrySpecPatch>;
...
export interface WorkloadEntryPatchArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1beta1.WorkloadEntrySpecPatch | undefined>;
}
