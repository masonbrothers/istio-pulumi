...
export class WorkloadEntry extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1beta1.WorkloadEntrySpec>;
...
export interface WorkloadEntryArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1beta1.WorkloadEntrySpec | undefined>;
}
