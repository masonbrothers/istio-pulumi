...
export class VirtualService extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1beta1.VirtualServiceSpec>;
...
export interface VirtualServiceArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1beta1.VirtualServiceSpec | undefined>;
}
