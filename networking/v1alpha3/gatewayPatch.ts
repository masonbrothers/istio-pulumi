...
export class GatewayPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha3.GatewaySpecPatch>;
...
export interface GatewayPatchArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha3.GatewaySpecPatch | undefined>;
}
