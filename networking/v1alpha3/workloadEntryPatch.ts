...
export class WorkloadEntryPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha3.WorkloadEntrySpecPatch>;
...
export interface WorkloadEntryPatchArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha3.WorkloadEntrySpecPatch | undefined>;
}
