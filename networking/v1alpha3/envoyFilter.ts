...
export class EnvoyFilter extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha3.EnvoyFilterSpec>;
...
export interface EnvoyFilterArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha3.EnvoyFilterSpec | undefined>;
}
