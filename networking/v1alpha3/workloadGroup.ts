...
export class WorkloadGroup extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha3.WorkloadGroupSpec>;
...
export interface WorkloadGroupArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha3.WorkloadGroupSpec | undefined>;
}
