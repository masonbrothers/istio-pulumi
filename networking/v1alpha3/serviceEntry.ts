...
export class ServiceEntry extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1alpha3.ServiceEntrySpec>;
...
export interface ServiceEntryArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1alpha3.ServiceEntrySpec | undefined>;
}
