...
export class VirtualService extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1.VirtualServiceSpec>;
...
export interface VirtualServiceArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1.VirtualServiceSpec | undefined>;
}
