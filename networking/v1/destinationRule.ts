...
export class DestinationRule extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.networking.v1.DestinationRuleSpec>;
...
export interface DestinationRuleArgs {
    ...
    spec?: pulumi.Input<inputs.networking.v1.DestinationRuleSpec | undefined>;
}
